...
# The hash is saved in an array and the user can print the array.
# The user is given the option to quit or reset the program.
# Roll credits!

# I used local variables input, saveop, hours, labor, cost, price, name, seelist
...
loop do
  ...
  if saveop == 'YES'
    ...
    print 'Would you like to see a list of your saved projects? Type yes or no'
    seelist = gets.chomp.upcase
    projects.each { |x| puts "#{x.keys}, $#{x.values}" } if seelist == 'YES'
